...
- Does not shut down the environment immediately after simulation; enters command-wait mode
...
def _enrich_action_context(
    ...
    try:
        ...
        # Enriching context failure does not affect the main flow
...
async def main():
    ...
    if args.twitter_only:
        ...
        # Run in parallel (each platform uses an independent log recorder)
