...
class ZepToolsService:
    ...
    def search_graph(
        ...
        """
        # Zep limits search queries to 400 characters
        truncated_query = query[:390] if len(query) > 390 else query
        logger.info(f"Graph search: graph_id={graph_id}, query={truncated_query[:50]}...")
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, auto-decomposes questions and multi-dimensional retrieval:
    ...
    def _generate_sub_queries(
        ...
        Decomposes complex questions into multiple independently searchable sub-queries
        """
...
Return a JSON formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        Get full panorama view, including all related content and historical/expired information:
        ...
        This tool is suitable for scenarios requiring full event picture and evolution tracking.
    ...
    def interview_agents(
        ...
        Calls real OASIS interview API to interview Agents running in simulation:
        1. Auto-reads persona files to understand all simulated Agents
        ...
        - Need real responses from simulated Agents (not LLM simulation)
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplement): Properly paired Chinese quotes with long text
                if not key_quotes:
...
- Do not use dividing lines (like ---, ***)
- When quoting interviewee original words, use quotation marks
