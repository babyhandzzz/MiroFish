...
Therefore, **entities must be real-world agents that can voice opinions and interact on social media**:
...
A. **Fallback types (must be included, placed as the last 2 in the list)**:
   - `Person`: Fallback type for any individual person. When a person does not belong to other more specific person types, they are classified here.
...
- Various people will appear in the text, such as "elementary school teachers", "bystanders", "some netizens"
...
- Ensure that source_targets of relationships cover the entity types you have defined
...
- Person: Any individual (used when not belonging to the above specific types)
...
4. All entity types must be real-world agents that can voice opinions, not abstract concepts
