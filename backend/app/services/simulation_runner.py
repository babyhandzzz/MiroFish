...
class SimulationRunner:
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If two platforms were running, both need to be completed
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this environment variable doesn't exist, and registration is also needed
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                - "twitter": Default to only interviewing on Twitter platform
                - "reddit": Default to only interviewing on Reddit platform
    ...
    def close_simulation_env(
        ...
        """
        Close the simulation environment (not stopping the simulation process)
