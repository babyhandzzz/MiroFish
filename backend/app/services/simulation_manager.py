...
Manages parallel simulations across Twitter and Reddit dual platforms
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Steps:
        1. Read and filter entities from Zep graph
        2. Generate OASIS Agent Profile for each entity (optional LLM enhancement, with parallelism)
