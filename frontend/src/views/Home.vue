            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirement in natural language (e.g., What public opinion trends would emerge if Wuhan University issued an announcement revoking Xiao's disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Using Space Grotesk as the main heading font and JetBrains Mono as the code/label font.
