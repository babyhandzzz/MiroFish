    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, automatically chunks documents, invokes Zep to build a knowledge graph, extracts entities and relationships, and forms temporal memory and community summaries
          </p>
